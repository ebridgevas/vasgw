    ...
    public static void main(String [] args){
        ...
        try{
           ...
           // _log.info("####### SCHEDULER INSTANCE 5 STARTED ####### at Date : "+new Date());
            System.out.println("####### SCHEDULER INSTANCE 5 STARTED ####### at Date : "+new Date());
        }catch(Exception ex){
            _log.error("Error Starting scheduler instance 5 at Date:"+new Date(), ex);
            ex.printStackTrace();
        }
