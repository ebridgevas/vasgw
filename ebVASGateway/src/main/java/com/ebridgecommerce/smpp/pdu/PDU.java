...
import com.ebridgecommerce.smpp.pdu.tlv.TLV;
import com.ebridgecommerce.smpp.pdu.tlv.TLVException;
import com.ebridgecommerce.smpp.pdu.tlv.TLVOctets;
 ...
 * 
 * Abstract base class for all classes which 
 ...
 * assignment, etc. It also implements setData and
 * getData methods as the header and optional params
 * parsing and composition is the same for all PDUs. The derived
 * classes on turn implement functions setBody and getBody.
 * 
 * The PDU has two descendants, Request and Response, which serve as a base 
 * classes for concrete PDU classes like SubmitSM, SubmitSMResp etc.
 * 
 */
...
//                debug.write(DPDU, "have "+optionalLength+" bytes left.");
        	...
        	/* David Tekeshe: Sept 1, 2006 */
        	// TODO Fix getCommandLength problem - returning wrong length
        	/* Will supress throw for now */
     ...
     * @see #getBody()
     * @see #getOptionalBody(java.util.Vector)
     * @see #getHeader()
     * @see #setData(ByteBuffer)
     */
...
//                    key+"\" value=\""+(value==null?"null":value)+"\"");
     ...
     * @see #setApplicationSpecificInfo(Object,Object)
     * @see #cloneApplicationSpecificInfo(java.util.Dictionary)
     */
