 ...
 * <a href="http://java.sun.com/j2se/1.5/docs/guide/intl/encoding.doc.html">
...
public class ShortMessage extends ByteData {
	...
	/**
	 * Max size of the message in octets. For multibyte encoded messages it means
	 * size after converting to sequence of octets.
	 */
	int maxLength = 0;
	...
	/**
	 * Construct the short message with max data length -- the max count of octets
	 * carried by the massege. It's not count of chars when interpreted with
	 * certain encoding.
	 * 
	 * @param maxLength
	...
	/**
	 * Construct the short message with mina nd max data length -- the min and max
	 * count of octets carried by the massege. It's not count of chars when
	 ...
	 * 
	 * @param buffer
	 *          the buffer containing the message data; must contain exactly the
	 *          data of the message (not zero terminated nor length tagged)
	 * @see #getMessage()
	 ...
	 *              if the required encoding is not available for the Java Runtime
	 *              system
	 */
	...
	/**
	 * Returns the message applying the provided encoding to convert the sequence
	 * of octets.
	 *
	 * @param encoding
...
//		}
		// return supported;
		/* TODO Check if character encoding is supported.*/
		return false;
	}
