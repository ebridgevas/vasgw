...
public class WrongSessionStateException extends SmppException
{
     ...
     */
    public WrongSessionStateException(int sessionType,
                                      int expectedState, int currentState)
    {
        this();
    ...
    public String getMessage()
    {
        if (hasSessionDetails) {
            ...
            if (expectedState != Session.STATE_NOT_ALLOWED) {
                msg = "The operation is not allowed in the current "+
                    typeDescription + " session state. "+
                    "Current state is "+getStateDescription(currentState)+
                    " required state(s) is "+getStateDescription(expectedState)+".";
            } else {
                msg = "The operation is not allowed in "+
     ...
     */
    public static String getStateDescription(int state, int testState,
                                              String currentDescr, String descr)
    {
