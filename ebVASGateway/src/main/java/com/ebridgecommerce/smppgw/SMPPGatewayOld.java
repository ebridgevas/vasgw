...
//	private MosmPDUListener pduListener;
...
//
//	public List<DeliverSM> deliverSMList;
//	
//	public SMPPGatewayOld(String telecelSmppIPAdress, int telecelSmppPort, String telelceSystemId, String telecelSystemPassword, String telecelSmppVersion,
...
//	public boolean bind() {
//
////		pduListener = new MosmPDUListener(this);
//
...
//			SMPPSinkResponse pduListener = new SMPPSinkResponse(this);
//			response = session.bind(request, pduListener);
//			System.out.println("---> " + response.debugString());
//			if (response.getCommandStatus() == Data.ESME_ROK) {
//				/* Spawn a SMPP Reciever */
//				new Thread(new SMPPReciever(this,telecelSmppIPAdress, telecelSmppPort, telelceSystemId, telecelSystemPassword, telecelSmppVersion,
//						telecelEnquireLinkRate, ebridgeSmppIPAdress, ebridgeSmppPort, ebridgeSystemId, ebridgeSystemPassword, ebridgeSmppVersion,
//						ebridgeEnquireLinkRate, isConnectedToEBridge, isConnectedToCcws)).start();
//				return true;
//			} else {
//				return false;
//			}
...
//			} else {
//				try {
//					Thread.sleep(telecelEnquireLinkRate);
//				} catch (InterruptedException ex) {
//				}
//			}
//		}
...
//			  SMPPGatewayOld smpptr = new SMPPGatewayOld(args[0], Integer.parseInt(args[1]), args[2], args[3],args[4],Long.parseLong(args[5]),
