...
public class SMPPTransmitterOld {
...
//	private MosmPDUListenerOld pduListener;
	...
	public SMPPTransmitterOld(String telecelSmppIPAdress, int telecelSmppPort, String telelceSystemId, String telecelSystemPassword, String telecelSmppVersion,
	...
	public static void main(String[] args) {
		...
		if (args.length == 1 ) {
			...
			connectEBridge(args[0],Integer.parseInt(args[1]),args[2],args[3],args[4],Long.parseLong(args[5]));
			  ...
			  SMPPTransmitterOld smpptr = new SMPPTransmitterOld(args[0], Integer.parseInt(args[1]), args[2], args[3],args[4],Long.parseLong(args[5]),
