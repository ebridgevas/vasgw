...
public class SMPPReceiver {
	...
	public SMPPReceiver(String smppIPAdress, int smppPort, String systemId, String systemPassword, String carrierType, String smscId, String queueName) throws JMSException {
	...
	public static void main(String[] args){
		try {
			new SMPPReceiver(args[0], Integer.parseInt(args[1]), args[2], args[3], args[4], args[5], args[6]).bind();
